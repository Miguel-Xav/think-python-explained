...
#part 1
radius = 5 #defing the radius of the sphere
voulme = (4/3) * math.pi * radius**3 #calculation of the volume of the sphere
print (round(voulme, 2)) #print the result of the volume with 2 decimals
...
print (math.exp(x)) #elevating e to the power of 2 with the function exp